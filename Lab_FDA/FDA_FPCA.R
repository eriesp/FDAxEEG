...
# can see the effect of smoothing in the covariance matrices 
#####################################################
...
# imposing periodicity get some modifications at the border
...
# outlier: Resolute (35)     it's the one in the norther part
...
# there's a shift of the positive one
